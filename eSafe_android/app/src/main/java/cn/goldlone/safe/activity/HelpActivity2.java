...
import cn.goldlone.safe.fragment.LocationHelpFragment;
import cn.goldlone.safe.fragment.LightFragment;
import cn.goldlone.safe.fragment.VideoFragment;
...
public class HelpActivity2 extends AppCompatActivity {
    private LocationHelpFragment helpFragment = new LocationHelpFragment();
    private long firstClickTime = 0;
    private ArrayList<Fragment> mFragments = new ArrayList<>();
    private String[] mTitles = {"定位求救", "隐秘录像","手电筒"};
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(!contact.equals("")){
                            try {
                                ...
                                Toast.makeText(HelpActivity2.this,"存储成功",Toast.LENGTH_SHORT).show();
                            } catch (IOException e) {
                                e.printStackTrace();
                            }
                        }
