    ...
    private void initDrawer() {
        ...
        drawer = new DrawerBuilder()
                ...
                .addDrawerItems(
                        ...
                        new PrimaryDrawerItem().withName("交流互动").withDescription("与家人一起互动").withIcon(R.drawable.ic_accessibility_black_48dp).withSelectable(false).withIdentifier(2).withTextColor(Color.BLACK),
                        new PrimaryDrawerItem().withName("紧急求救").withDescription("设定紧急求救信息").withIcon(R.drawable.ic_report_problem_black_48dp).withSelectable(false).withIdentifier(3).withTextColor(Color.BLACK),
                        new PrimaryDrawerItem().withName("健康检测").withDescription("获取健康信息").withIcon(R.drawable.ic_favorite_border_black_48dp).withSelectable(false).withIdentifier(5).withTextColor(Color.BLACK),
                        new PrimaryDrawerItem().withName("足迹异常监测").withDescription("分析家人的位置状态").withIcon(R.drawable.ic_public_black_48dp).withSelectable(false).withIdentifier(6).withTextColor(Color.BLACK),
                        new PrimaryDrawerItem().withName("购物平台").withDescription("时尚购物").withIcon(R.drawable.shop).withSelectable(false).withIdentifier(7).withTextColor(Color.BLACK),
                        new PrimaryDrawerItem().withName("义务服务").withDescription("更好的服务").withIcon(R.drawable.yiwu).withSelectable(false).withIdentifier(8).withTextColor(Color.BLACK)
                )
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        if (drawerItem != null) {
                            if (drawerItem.getIdentifier() == 2) {
                                ...
                                startActivity(new Intent(MainActivity.this, Compulsory_service.class));
                            }
                        }
                        return false;
                    }
